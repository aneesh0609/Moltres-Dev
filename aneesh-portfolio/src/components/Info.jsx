...
const GetInTouch = () => {
      ...
      <div className="max-w-6xl mx-auto px-4 py-2">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div>
              <p className=" text-gray-900 sm:text-sm mb-6">
                Feel free to reach out for collaborations, opportunities, or just to say hello!
              </p>
            </div>

            <div className="space-y-4">
              <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-gray-900 to-gray-500 rounded-lg">
 ...
 <div className="bg-gradient-to-r from-gray-800  to-gray-600 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-3 top-3 w-4 h-4 text-gray-900" />
                  <input
                    type="text"
                    name="name"
                     value={name}
                     ...
                     required
                    className="w-full pl-10 pr-3 py-2 text-sm bg-gray-100 border border-gray-600 text-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div>
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-3 w-4 h-4 text-gray-900" />
                  <input
                    type="email"
                    name="email"
                     value={email}
              ...
              onChange={e => setText(e.target.value)}
                required
                  className="w-full px-3 py-2 text-sm bg-gray-100 border text-black border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                  placeholder=""
                ></textarea>
              </div>
